class InfoQueueUser {
  ...
  InfoQueueUser({this.qol_mem_id, this.qol_date, this.qol_seq, this.qus_name, this.ts_time_start, this.ts_time_stop, this.svt_name, this.svst_name});
  ...
  factory InfoQueueUser.fromJson(Map<String, dynamic> json) {
    return InfoQueueUser(
      ...
      qol_seq: json['qol_seq'] as String,
